        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                <p>
                  Aprende a utilizar herramientas como FODA y PESTEL para
                  analizar el entorno de tu organización y tomar decisiones
                  informadas.
                </p>
              </CardContent>
              <CardFooter>
            ...
            <Card>
              ...
              <CardContent>
                <p>
                  Descubre las cuatro etapas clave del proceso administrativo y
                  cómo implementarlas efectivamente en tu organización.
                </p>
              </CardContent>
              <CardFooter>
                <Button variant="outline">Leer Más</Button>
            ...
            <Card>
              ...
              <CardContent>
                <p>
                  Explora las principales áreas funcionales de una organización
                  y cómo contribuyen al logro de los objetivos empresariales.
                </p>
              </CardContent>
              <CardFooter>
                <Button variant="outline">Leer Más</Button>
